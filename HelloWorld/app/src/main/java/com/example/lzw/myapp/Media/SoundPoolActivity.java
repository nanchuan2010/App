...
public class SoundPoolActivity extends Activity implements SoundPool.OnLoadCompleteListener {
    ...
    protected void onResume() {
        ...
        //sid_bark=soundPool.load("/mnt/sdcar/dogbark.mp3",PRIORITY)/
    ...
    public void onLoadComplete(SoundPool sPool, int sid, int status) {
        ...
        final float currentVolume=((float)aMgr.getStreamVolume(AudioManager.STREAM_MUSIC))/((float)aMgr.getStreamMaxVolume(AudioManager.STREAM_MUSIC));
